 ...
 <div className="md:w-[60%] w-full space-y-6">
      ...
      <section className="w-full px-6 md:px-20 pb-[100px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-[80px]">
          <div className="w-full overflow-hidden">
            <img src="/images/glowora/image3.jpeg" className="w-full h-auto object-cover rounded-lg mb-4" />
          ...
          <div className="w-full overflow-hidden">
            <img src="/images/glowora/image2.jpeg" className="w-full h-auto object-cover rounded-lg mb-4" />
          ...
          <div className="w-full overflow-hidden">
            <img src="/images/glowora/image4.jpeg" className="w-full h-auto object-cover rounded-lg mb-4" />
  ...
  Placed products in everyday settings like bathrooms and travel kits to boost relatability and shareability.
      ...
      <div className="max-w-5xl mx-auto ">
       ...
       <strong>
        ...
        {/* Image */}
        <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-6 pt-[150px] pb-[150px] rounded-lg mt-5" style={{ backgroundColor: '#b04f84'}}>
          <div className="w-full overflow-hidden">
            <img src="/images/glowora/image8.jpeg" className="w-full h-auto object-cover mb-4 rounded-lg" />
