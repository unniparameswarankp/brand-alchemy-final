...
>
  ...
  >
    ...
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <Image width="1000" height="1000" src="/images/glowora/image3.jpeg" className="w-full h-auto object-cover rounded-lg mb-4" alt="Business Card" />
    ...
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <Image width="1000" height="1000" src="/images/glowora/image2.jpeg" className="w-full h-auto object-cover rounded-lg mb-4" alt="Newspaper Ad" />
    ...
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <Image width="1000" height="1000" src="/images/glowora/image4.jpeg" className="w-full h-auto object-cover rounded-lg mb-4" alt="Packaging" />
