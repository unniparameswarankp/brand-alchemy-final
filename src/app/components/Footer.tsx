    ...
    <footer className="bg-black text-white py-16 ba-footer">
      <div className="ba-container">
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          ...
          <Link target="_blank" rel="noopener noreferrer" className="text-gray-400 cursor-pointer" href="https://www.facebook.com/brandalchemy.nz"><FaFacebook /></Link>
          <Link target="_blank" rel="noopener noreferrer" className="text-gray-400 cursor-pointer" href="https://www.instagram.com/brand.alchemy.nz/"><FaInstagram /></Link>
          <Link target="_blank" rel="noopener noreferrer" className="text-gray-400 cursor-pointer" href="http://www.linkedin.com/company/brandalchemynz"><FaLinkedin  /></Link>
          <Link target="_blank" rel="noopener noreferrer" className="text-gray-400 cursor-pointer" href="https://nz.pinterest.com/brandalchemy_nz"><FaPinterest /></Link>
          <Link target="_blank" rel="noopener noreferrer" className="text-gray-400 cursor-pointer" href="https://www.threads.com/@brand.alchemy.nz"><ThreadsIcon /></Link>
          <Link target="_blank" rel="noopener noreferrer" className="text-gray-400 cursor-pointer" href="https://x.com/brandalchemynz"><XIcon /></Link>
          <Link target="_blank" rel="noopener noreferrer" className="text-gray-400 cursor-pointer" href="https://www.tiktok.com/@brand.alchemy.nz"><SiTiktok /></Link>
          <Link target="_blank" rel="noopener noreferrer" className="text-gray-400 cursor-pointer" href="https://www.youtube.com/@brandalchemy_nz"><FaYoutube /></Link>
